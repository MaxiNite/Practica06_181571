...
import kotlinx.android.synthetic.main.activity_detalla_pelicula.view.*
...
class catalogo : AppCompatActivity() {
    ...
    var adapterSeries: SerireAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gv_Pelicula.adapter = adapterPelicula
        adapterSeries = SerireAdapter(this, series)
        gv_Serie.adapter = adapterSeries
    }
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            vista.iv_Pelicula.setOnClickListener(){
                var intent = Intent(context, DetallaPelicula:: class.java)
    ...
    class SerireAdapter: BaseAdapter {
